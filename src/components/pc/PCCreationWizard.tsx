...
export function PCCreationWizard({ onComplete, onCancel }: {
    ...
    const handleCommit = useCallback(async () => {
        ...
        try {
            ...
            // Desktop does not yet have the full mobile combat loadout pipeline
            // (Phase 7). Build a minimal PC NPCEntry with the point-buy stats and
            // archetype; combat fields will be populated when Phase 7 lands.
            const pcEntry: NPCEntry = {
                id: uid(),
            ...
            // Mark the combat tier on the entry for Phase 7 wiring. We keep this in a
            // loose field on the entry so it survives without a schema bump for now.
    ...
    }, [allocation, answers, addNPC, auxProvider, isOP, selectedArchetype, setCharacterProfileData, updateContext, onComplete]);
