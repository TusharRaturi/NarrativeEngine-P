...
const sealChapterCombinedMock = vi.fn(async () => ({
    ...
    divergences: { newEntries: [{ id: 'd1', chapterId: 'CH01', category: 'world_state', text: 'The harbor flooded.', sceneRef: '001', npcIds: [], pinned: false, enabled: true, source: 'seal', importance: 7 }], updates: [], invalidations: [] } as any,
