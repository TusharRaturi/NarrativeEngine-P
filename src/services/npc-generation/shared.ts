...
// sanitizeSignatureKit moved to services/npc/signatureKit.ts (a pure, LLM-free module)
// so the deterministic lore parser can reuse the same bounds. Re-exported here to keep
