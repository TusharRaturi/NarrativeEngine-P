    ...
    return (
        <div>
            ...
            <textarea
                ...
                rows={rows}
                className={`w-full bg-void border px-3 py-2 text-[16px] md:text-xs text-text-primary placeholder:text-text-dim/40 font-mono resize-y transition-opacity min-h-[100px] md:min-h-0 ${active ? 'border-border' : 'border-border/40 opacity-50'
                    }`}
            />
            {hint && (
